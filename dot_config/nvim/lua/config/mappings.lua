...
map("n", "<leader>w", "<C-w>v<C-w>l", { noremap = true, desc = "Open new vertical split and switch to it" })
map("n", "<leader>s", "<C-w>v<C-w>s", { noremap = true, desc = "Open horizontal split and switches to it" })
map("n", "<C-h>", "<C-w>h", { noremap = true, desc = "Control-<vim navigation> to navigate split panels" })
map("n", "<C-j>", "<C-w>j", { noremap = true, desc = "Control-<vim navigation> to navigate split panels" })
map("n", "<C-k>", "<C-w>k", { noremap = true, desc = "Control-<vim navigation> to navigate split panels" })
map("n", "<C-l>", "<C-w>l", { noremap = true, desc = "Control-<vim navigation> to navigate split panels" })
